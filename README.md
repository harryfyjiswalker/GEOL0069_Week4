...
The GMM-based classifier achieves approximately 99.6% overall accuracy, demonstrating that a two component mixture model applied to just two features is sufficient to cleanly separate these surface types.
